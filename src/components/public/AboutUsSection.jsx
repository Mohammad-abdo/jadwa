    ...
    <section className="py-20 md:py-28 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16 animate-fade-in-down">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#1a4d3a] to-[#2d5f4f] mx-auto mb-8"></div>
        </div>

        <Row gutter={[32, 32]} className="mb-16">
          <Col xs={24} lg={12}>
            <div className={`${language === 'ar' ? 'text-right' : 'text-left'}`}>
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-[#1a4d3a]">
                {language === 'ar' 
          ...
          <Col xs={24} lg={12}>
            <div className={`${language === 'ar' ? 'text-right' : 'text-left'}`}>
              <Card className="h-full border-0 shadow-lg rounded-2xl bg-gradient-to-br from-[#1a4d3a] to-[#2d5f4f] text-white">
          ...
          <Row gutter={[24, 24]}>
            {values.map((value, index) => (
              <Col xs={24} sm={12} lg={6} key={index}>
                <Card
                  className={`h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 rounded-2xl text-center hover-lift card-entrance`}
